...
| Mostra Imagem | `mostra-imagem.html`, `mostra/exames.html`, `mostra/volume.html`, `mostra/img/`, `mostra/data/` | Mostra comparativa de visualizadores abertos de exames de imagem (base do Simulador 02): NiiVue, Open Anatomy e Papaya embutidos, OHIF como link; visualizador próprio com TC de crânio (34 cortes, janelamento) e radiografia anotada; seção "Fontes anotadas por especialistas" com amostras reais: Häggström (Commons), TotalSegmentator e VerSe no NiiVue (`volume.html`, rótulo por voxel), GRAZPEDWRI-DX e FracAtlas com caixas do dataset, CheXmask com máscara, JSRT + SCR com contornos manuais de pulmões, coração e clavículas. Regra: nenhuma anotação feita por nós |
